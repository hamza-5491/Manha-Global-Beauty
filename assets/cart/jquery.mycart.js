  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    if (!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<table class="table table-responsive-lg" id="' + idCartTable + '"></table>' +
        '</div>' +
        '<div class="modal-footer">' +
        '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>' +
        '<a type="button" href="checkout.html" class="btn '  + classCheckoutCart + '">Checkout</a>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    ...
    var drawTable = function () {
      ...
      $.each(products, function () {
        ...
        $cartTable.append(
          ...
          '<td class="text-center" style="width: 100px;"><img width="100px" src="' + this.image + '"/></td>' +
          ...
          '<td title="Total" class="text-center ' + classProductTotal + '">' + options.currencySymbol + MathHelper.getRoundedNumber(total) + '</td>' +
      ...
      // if you want to give discount then remove this code from comment
